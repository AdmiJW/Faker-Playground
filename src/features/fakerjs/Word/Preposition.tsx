...
const tooltip = `Returns a preposition of random or optionally specified length.`;
...
type Output = ReturnType<typeof faker.word.preposition>;
...
export function Preposition() {
    ...
    const formik = useFormik<State>({
        ...
        onSubmit: (values, { setErrors }) => {
            ...
            setOutput(preposition);
            toast.success('Faked preposition!');
        },
    });

    return (
        <FakerSection title='Preposition' id='preposition' tooltip={tooltip}>
