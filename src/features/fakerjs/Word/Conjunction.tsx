...
const tooltip = `Returns a conjunction of random or optionally specified length.`;
...
type Output = ReturnType<typeof faker.word.conjunction>;
...
export function Conjunction() {
    ...
    const formik = useFormik<State>({
        ...
        onSubmit: (values, { setErrors }) => {
            ...
            setOutput(conjunction);
            toast.success('Faked conjunction!');
        },
    });

    return (
        <FakerSection title='Conjunction' id='conjunction' tooltip={tooltip}>
