...
const tooltip = `Returns an adverb of random or optionally specified length.`;
...
type Output = ReturnType<typeof faker.word.adverb>;
...
export function Adverb() {
    ...
    const formik = useFormik<State>({
        ...
        onSubmit: (values, { setErrors }) => {
            ...
            setOutput(adverb);
            toast.success('Faked adverb!');
        },
    });

    return (
        <FakerSection title='Adverb' id='adverb' tooltip={tooltip}>
